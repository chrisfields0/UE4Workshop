...
void ATPSCharacter::TakeGunDamageCrossServer_Implementation(float Damage, const struct FDamageEvent& DamageEvent, AController* EventInstigator, AActor* DamageCauser)
{
	if (!HasAuthority())
	{
		return;
